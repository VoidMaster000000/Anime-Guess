      ...
      >
        <div className="flex items-center gap-2 px-2 py-1.5 rounded-xl bg-gradient-to-r from-zinc-800/90 to-zinc-900/90 border border-zinc-700/50 hover:border-purple-500/30 transition-all duration-200">
          ...
          <div className="relative">
            ...
            {/* Online indicator */}
            <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 rounded-full border-2 border-zinc-900" aria-hidden="true" />
          </div>
        ...
        {isOpen && (
          ...
          >
            ...
            >
                  ...
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-cyan-500 p-[2px]">
                    <div className="w-full h-full rounded-[10px] bg-zinc-900 flex items-center justify-center overflow-hidden">
                      {user?.avatarImage ? (
                        ...
                        <User className="w-7 h-7 text-zinc-500" aria-hidden="true" />
                      )}
                    </div>
                  </div>
                  {/* Level badge */}
              ...
              <div className="space-y-1.5">
                ...
                <div
                  ...
                  aria-valuemin={0}
                  aria-valuemax={100}
                  aria-label={`Level ${level} progress: ${xpInCurrentLevel} of ${xpNeededForNextLevel} XP`}
                >
                  <motion.div
            ...
            >
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-yellow-500/20 flex items-center justify-center" aria-hidden="true">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-orange-500/20 flex items-center justify-center" aria-hidden="true">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-blue-500/20 flex items-center justify-center" aria-hidden="true">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-green-500/20 flex items-center justify-center" aria-hidden="true">
            ...
            >
              {[
                ...
                <motion.button
                  ...
                  role="menuitem"
                >
                  <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-purple-500/20 flex items-center justify-center transition-colors" aria-hidden="true">
              ...
              <div className="my-2 h-px bg-zinc-800" role="separator" aria-hidden="true" />
              ...
              <motion.button
                ...
                role="menuitem"
              >
                <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-red-500/20 flex items-center justify-center transition-colors" aria-hidden="true">
